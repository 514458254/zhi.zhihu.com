...
function(e) {
	...
	var o = n(16),
		...
		_ = (t.listMessages = (0, d.createAction)("list messages", function() {
			...
			return (0, h["default"])("/zhi/messages?" + g({
				offset: (e - 1) * b,
				limit: b
			})).then(function(t) {
				return {
			...
			return (0, h["default"])("/zhi/messages", {
				method: "POST",
				body: e
			})
		}), t.payMessage = (0, d.createAction)("pay message", function(e) {
			return y ? (0, h["default"])("/zhi/messages/" + e.id + "/paid", {
				method: "PUT"
			}).then(function() {
				return e
			}) : new l["default"](function(t, n) {
				return m["default"].Wechat ? void(0, h["default"])("/zhi/messages/" + e.id + "/pay").then(function(r) {
			...
			return (0, h["default"])("/zhi/messages/" + e.id)
		}),
	...
	t.confirmPaid = (0, d.createAction)("get message", function(e) {
		...
		return function(n, r) {
			(0, h["default"])("/zhi/messages/" + e.id + "/rating", {
				method: "PUT",
				body: {
					value: t
				}
